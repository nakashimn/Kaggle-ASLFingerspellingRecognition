config = {
    ...
    "train_folds": [0],
    "label": "phrase",
    "experiment_name": "asl-trial-v4",
    "path": {
        "dataset": "/kaggle/input/asl-fingerspelling-all/",
        "trainmeta": "/kaggle/input/asl-fingerspelling-all/train_withface_th_1.0.csv",
        "testmeta": "/kaggle/input/asl-fingerspelling-all/train_withface_th_1.0.csv",
        "predmeta": "/kaggle/input/asl-fingerspelling-all/train_withface_th_1.0.csv",
        ...
        "model_dir": "/kaggle/input/asl-trial-v4/",
